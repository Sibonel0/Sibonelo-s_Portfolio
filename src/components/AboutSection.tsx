          ...
          >
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="p-6 bg-white/5 backdrop-blur-xl border-white/20 shadow-2xl shadow-black/30 hover:border-emerald-500/50 hover:shadow-emerald-500/10 transition-all duration-300 group">
