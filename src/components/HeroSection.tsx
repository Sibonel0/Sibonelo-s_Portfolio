        ...
        >
          ...
          >
            ...
            <div className="flex items-center space-x-4">
              {[
                { icon: Github, href: 'https://github.com/Sibonel0' },
                { icon: Linkedin, href: 'https://linkedin.com/in/sibonelo-dlamini-0b5597226' },
                { icon: Mail, href: 'mailto:sibonelodlamini25@gmail.com' }
                ...
                <motion.a
                  ...
                  className="w-12 h-12 bg-white/10 backdrop-blur-md border border-white/20 rounded-full flex items-center justify-center text-white hover:bg-white/20 hover:border-white/30 hover:shadow-lg hover:shadow-white/20 transition-all duration-300"
                >
