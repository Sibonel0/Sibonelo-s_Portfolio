        ...
        <div className="grid md:grid-cols-3 gap-8">
          {skillCategories.map((category, categoryIndex) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="p-6 bg-white/5 backdrop-blur-xl border-white/20 shadow-2xl shadow-black/30 hover:bg-white/10 hover:border-white/30 transition-all duration-300">
                ...
                <div className="space-y-4">
                  {category.skills.map((skill, skillIndex) => (
                    ...
                    >
                      ...
                      <div className="w-full bg-white/10 backdrop-blur-sm border border-white/10 rounded-full h-2 overflow-hidden">
                        <motion.div
                          initial={{ width: 0 }}
